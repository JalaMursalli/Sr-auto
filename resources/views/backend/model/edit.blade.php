                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="POST"
                                action="{{ route('backend.model.update', $model->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                        ...
                                        <select name="brend_id" class="form-control selectric">
                                            ...
                                            @foreach ($brends as $brend)
                                                <option value="{{ $brend->id }}"
                                                    {{ $model->brend_id == $brend->id ? 'selected' : '' }}>
                                                    {{ $brend->name_az }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="fuel_ids[]" multiple class="form-control selectric">
                                            @foreach ($fuels as $fuel)
                                                <option value="{{ $fuel->id }}"
                                                    {{ $model->fuels()->where('fuel_id', $fuel->id)->exists() ? 'selected' : '' }}>
                                                    {{ $fuel->name }}
                                                </option>
                                            @endforeach
                                        </select>
