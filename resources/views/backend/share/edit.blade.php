        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="needs-validation" method="POST" action="{{ route('backend.share.update', $share->id) }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="url" type="text"
                                                value="{{ $share?->url }}" id="example-text-input">
                                            @error('url')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$share?->icon}}" alt="">
                                            </div>
                                        </div>
                                    </div>
