    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                   <form class="needs-validation" method="POST" action="{{ route('backend.brend-social.update',$contact->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <input type="hidden" name="brend_id" value="{{$social->brend_id}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$social?->icon}}" alt="">
                                            </div>
                                        </div>
                                    </div>
