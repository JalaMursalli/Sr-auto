            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="/{{app()->getLocale()}}" class="auth-logo">
                                <img src="{{asset('backend/assets/images/logo-sr-auto 1.png')}}" height="100" class="logo-dark mx-auto" alt="">
                                <img src="{{asset('backend/assets/images/logo-sr-auto 1.png')}}" height="100" class="logo-light mx-auto" alt="">
                            </a>
                        </div>
                    </div>
