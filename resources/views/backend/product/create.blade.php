                    ...
                    <div class="card">
                        <div class="card-body">
                           <ul class="nav nav-pills nav-justified" role="tablist">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('backend.product.store') }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Alt
                                                    (Az)</label>
                                                <input type="text" class="form-control" value="{{ old('alt_image_az') }}"
                                                    name="alt_image_az">
                                                @error('alt_image_az')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-12">
                                            <label for="example-text-input" class="col-form-label">Güc və sürət (Az)
                                            </label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="col-md-12">
                                            <label for="example-text-input" class="col-form-label">Avtomobilin ölcüləri
                                                (Az)
                                            </label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="col-md-12">
                                            <label for="example-text-input" class="col-form-label">Əlavə Xüsusiyyətlər
                                                (Az)
                                            </label>
                                            <div class="col-sm-12">
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="row mb-3">
                                            <div class="col-md-6"> <label for="example-text-input"
                                                    class="col-form-label">Ad
                                                    (En)</label>
                                                <div class="">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="meta_title_en" type="text"
                                                        value="{{ $product?->meta_title_en }}" id="example-text-input">
                                                    @error('meta_title_en')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" name="meta_title_ru" type="text"
                                                        value="{{ $product?->meta_title_ru }}" id="example-text-input">
                                                    @error('meta_title_ru')
                                                        <div class="invalid-feedback" style="display: block">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <label for="example-text-input" class="col-form-label">Alt
                                                    (Ru)</label>
                                                <input type="text" class="form-control"
                                ...
                                <div class="row mb-3 px-3">
                                    <div class="col-md-4">
                                        <label for="example-price-input" class="col-form-label">Qiymət</label>
                                        <div class="col-sm-12">
                                            <input class="form-control" name="price" type="text"
                                                value="{{ $product?->price }}" id="example-price-input">
                                            @error('price')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-year-input" class="col-sm-2 col-form-label">İl</label>
                                        <div class="col-sm-12">
                                            <input class="form-control" name="year" type="number"
                                                value="{{ $product?->year }}" id="example-year-input">
                                            @error('year')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-engine-volume-input" class=" col-form-label">Mühərrik
                                            həcmi</label>
                                        <div class="col-sm-12">
                                            <input class="form-control" name="engine_volume" type="text"
                                                value="{{ $product?->engine_volume }}" id="example-engine-volume-input">
                                            @error('engine_volume')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-expence-input" class=" col-form-label">Sərfiyyat</label>
                                        <div class="">
                                            <input class="form-control" name="expence" type="text"
                                                value="{{ $product?->expence }}" id="example-expence-input">
                                            @error('expence')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-horse-power-input" class=" col-form-label">At gücü</label>
                                        <div class="">
                                            <input class="form-control" name="horse_power" type="text"
                                                value="{{ $product?->horse_power }}" id="example-horse-power-input">
                                            @error('horse_power')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-acceleration-input" class="col-form-label">Sürətlənmə</label>
                                        <div class="">
                                            <input class="form-control" name="acceleration" type="text"
                                                value="{{ $product?->acceleration }}" id="example-acceleration-input">
                                            @error('acceleration')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-battery-input" class="col-form-label">Battery</label>
                                        <div class="">
                                            <input class="form-control" name="battery" type="text"
                                                value="{{ $product?->battery }}" id="example-battery-input">
                                            @error('battery')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-charge-input" class="col-form-label">Charge</label>
                                        <div class="">
                                            <input class="form-control" name="charge" type="text"
                                                value="{{ $product?->charge }}" id="example-charge-input">
                                            @error('charge')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label for="example-max-distance-input" class="col-form-label">Maksimal
                                            yürüş</label>
                                        <div class="">
                                            <input class="form-control" name="max_distance" type="text"
                                                value="{{ $product?->max_distance }}" id="example-max-distance-input">
                                            @error('max_distance')
                                                <div class="invalid-feedback" style="display: block">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <label class="col-form-label text-md-right">Kampaniya Status</label>
                                        <div class="col-12">
                                            <select name="sale_status" class="form-control selectric">
                                                <option value="">Statusu seç</option>
                                                <option value="0">Kampaniya yoxdu </option>
                                ...
                                <div class="row mb-3 px-3">
                                    ...
                                    <div class="form-group row mb-3">
                                       ...
                                       <div class="row mb-3">
                                    <label for="image-upload" class="col-12 col-form-label">Əsas şəkil (Ölçü
                                        670x454)</label>
                                    <div class="col-sm-10">
                                        <div id="image-preview" class="image-preview">
                                                        ...
                                                        <div class="feature-group mb-4">
                                                            <div class="row mb-3">
                                                                <label class="col-sm-2 col-form-label">Xüsusiyyət
                                                                    Qrupu</label>
                                                                <div class="col-sm-10">
                                                                    <select name="features[{{ $index }}][group_id]"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="tab-pane active"
                                                                    id="feature-az-{{ $index }}" role="tabpanel">
                                                                    <div class="row mb-3">
                                                                ...
                                                                <div class="tab-pane" id="feature-en-{{ $index }}"
                                                                    role="tabpanel">
                                                                    <div class="row mb-3">
                                                                ...
                                                                <div class="tab-pane" id="feature-ru-{{ $index }}"
                                                                    role="tabpanel">
                                                                    <div class="row mb-3">
            ...
            <div class="tab-content p-3 border border-top-0 rounded-bottom">
                ...
                <div class="tab-pane active" id="feature-az-${newIndex}" role="tabpanel">
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Açar</label>
                        <div class="col-sm-10">
                            <input type="text" required name="features[${newIndex}][key_az]" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Dəyər</label>
                        <div class="col-sm-10">
                            <input type="text" required name="features[${newIndex}][value_az]" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="feature-ru-${newIndex}" role="tabpanel">
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Ключ</label>
                        <div class="col-sm-10">
                            <input type="text" name="features[${newIndex}][key_ru]" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Значение</label>
                        <div class="col-sm-10">
                            <input type="text" name="features[${newIndex}][value_ru]" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
